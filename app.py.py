...
with st.sidebar:
    ...
    menu = st.radio(
        "Pilih Halaman:",
        ["📊 Dashboard Utama", "🔍 Screening Saham", "🌏 Indeks Global"],
        index=0,
        key="menu_navigasi"
    )
...
# ============================================
    ...
    def analisa_saham_scalping(ticker, min_price=90, max_price=999999):
        ...
        return {
            ...
            "Status Kenaikan": status_kenaikan,
    ...
    # ============================================
    # TABEL REKOMENDASI DARI HISTORY
    # ============================================
    st.markdown("---")
...
# ============================================
    ...
    # ============================================
    # TAMPILAN INDEKS GLOBAL LAINNYA
    # ============================================
